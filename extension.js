...
function registerCommands(context) {
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand("verbalist.helloWorld", () =>
        commandCallback("helloWorld")
    )
  );

  context.subscriptions.push(
    vscode.commands.registerCommand("verbalist.startRecordAudio", () =>
        commandCallback("startRecordAudio")
    )
  );

  context.subscriptions.push(
    vscode.commands.registerCommand("verbalist.stopRecordAudio", () =>
        commandCallback("stopRecordAudio")
    )
  );
